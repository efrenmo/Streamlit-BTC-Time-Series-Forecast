...
with st.sidebar:
    ...
    #st.markdown("< style='text-align: center;'>Table of contents</h1>", unsafe_allow_html=True) #; color: black
...
with st.container():      
    ...
    with tab1:
        ...
        st.write("""
        In this notebook I'll use [**Prophet**](https://facebook.github.io/prophet/) time series forecasting 
